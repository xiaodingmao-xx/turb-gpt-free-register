...
# 当邮件接口提供时间戳时，超过此年龄的 OTP 不参与候选；本次触发时间校验优先级更高。
OTP_MAX_MESSAGE_AGE_SECONDS = 3600

# GenericAPI 无法提供时间戳或 message id 时，要求发信前成功抓取接口基线。
